...
namespace HL_PhysicsEngine
{
	...
	//create a colour from 0-255 values for 3 colour components
	void Actor::Color(float r, float g, float b)
	{
		PxVec3 unitColour = PxVec3(r / 255.0f, g / 255.0f, b / 255.0f);

		this->Color(unitColour);
	}
	...
	/// <summary>
	/// Return a vector of PxShape*. Input -1 for all shapes.
	/// </summary>
