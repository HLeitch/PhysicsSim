...
//			pairFlags |= PxPairFlag::eNOTIFY_CONTACT_POINTS;
	...
	public:
		...
		virtual void CustomUpdate() 
		{
			...
			PxTransform transform = ((PxCloth*)cloth->Get())->getGlobalPose();
			transform.p.z -= 0.15f*sin(px_scene->getTimestamp()/300);

			////target pose moves cloth with effects on the fabric
			//((PxCloth*)cloth->Get())->setTargetPose(transform);
		}
